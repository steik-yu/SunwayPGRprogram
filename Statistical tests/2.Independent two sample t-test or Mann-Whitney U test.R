...
t.test(Tumor_Size_mm ~ Economic_Classification, data = CRC_dataset)

# If Tumor_Size_mm NOT normally distributed
wilcox.test(Tumor_Size_mm ~ Economic_Classification, data = CRC_dataset)
